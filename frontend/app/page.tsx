...
export default async function HomePage() {
  ...
  return (
    <>
      {/* ========== HERO SECTION ========== */}
      <section className="relative overflow-hidden py-16 sm:py-24 lg:py-[110px]">
        <div
          className="pointer-events-none absolute -inset-0"
          style={{
            background:
              "radial-gradient(820px 480px at 88% -12%, rgba(67,56,202,.10), transparent 62%), radial-gradient(620px 420px at -8% 110%, rgba(99,102,241,.08), transparent 58%)",
          }}
        />
        {/* decorative arcs, hidden on small screens to avoid clutter */}
        <div className="pointer-events-none absolute -bottom-[260px] -right-[180px] hidden h-[640px] w-[640px] rounded-full border border-brand/15 sm:block">
        ...
        <Plus className="pointer-events-none absolute right-[8%] top-[34%] hidden h-4 w-4 text-brand/35 sm:block" />
        <Plus className="pointer-events-none absolute bottom-[22%] left-[11%] hidden h-4 w-4 text-brand/35 sm:block" />
        <Plus className="pointer-events-none absolute right-[30%] top-[12%] hidden h-4 w-4 text-brand/35 sm:block" />
        ...
        <div className="relative mx-auto max-w-[1180px] px-4 sm:px-6">
          ...
          <form
            className="mt-8 flex max-w-[580px] flex-col gap-2 rounded-[28px] border border-line bg-card p-1.5 shadow-card focus-within:border-brand/55 focus-within:ring-4 focus-within:ring-brand/15 sm:flex-row sm:rounded-full"
            action="/catalog"
            method="get"
            role="search"
          >

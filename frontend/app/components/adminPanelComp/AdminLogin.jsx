            ...
            <div className="relative z-10 w-full max-w-md">
                <div className="rounded-xl2 border border-white/10 bg-white/95 p-5 shadow-card backdrop-blur-sm sm:p-6 md:p-8">
                    ...
                    <div className="mb-5 text-center sm:mb-6">
                        ...
                        <p className="mt-1.5 text-xs font-medium text-muted sm:text-sm">
                            Click the button below to access admin panel.
                        </p>
                    </div>
                    ...
                    <button
                        onClick={handleLogin}
                        disabled={loading}
                        className="group relative flex w-full items-center justify-center gap-2 rounded-full bg-[#47735B] px-4 py-2.5 text-sm font-semibold text-white transition-all duration-300 hover:bg-[#3A5F4A] hover:shadow-lg hover:shadow-[#47735B]/30 disabled:opacity-60 disabled:cursor-not-allowed sm:px-6 sm:py-3 sm:text-base"
                    >
                        {loading ? (
                            <>

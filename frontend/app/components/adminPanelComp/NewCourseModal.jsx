// app/admin/components/NewCourseModal.jsx
"use client";
            ...
            >
                ...
                <div className="flex flex-wrap gap-3">
                    <button
                        ...
                        className="flex-1 inline-flex items-center justify-center gap-2 rounded-full bg-brand-deep px-6 py-2.5 font-bold text-base text-white transition-colors hover:bg-[#241f6b]"
                    >

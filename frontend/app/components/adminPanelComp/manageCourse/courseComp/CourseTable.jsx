// app/components/adminPanelComp/manageCourse/courseComp/CourseTable.jsx
"use client";
    ...
    return (
        <div className="rounded-xl2 border border-line bg-card p-4 shadow-card sm:p-6">
            ...
            <div className="mb-5 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                <div>
                    <h2 className="text-xl font-bold tracking-tight text-ink sm:text-2xl">My Courses</h2>
                    <p className="text-sm text-muted">Create and manage your courses.</p>
                </div>

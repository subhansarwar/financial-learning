// app/components/adminPanelComp/manageCaseStudies/caseStudiesComp/CaseStudiesTable.jsx
"use client";
    ...
    return (
        <div className="rounded-xl2 border border-line bg-card p-4 shadow-card sm:p-6">
            ...
            <div className="mb-5 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                <div>
                    <h2 className="text-xl font-bold tracking-tight text-ink sm:text-2xl">Case Studies</h2>
                    <p className="text-sm text-muted">Create and manage case studies.</p>
                </div>
                                    ...
                                    <td className="px-4 py-3">
                                        <div className="flex items-center gap-3">
                                            ...
                                            <div className="min-w-0">
                                                <p className="truncate font-bold text-ink">{caseStudy.title}</p>
                                                <p className="truncate text-xs text-muted">{caseStudy.slug}</p>
                                            </div>
                                        </div>
                                    </td>

// app/components/adminPanelComp/manageCaseStudies/caseStudiesComp/TablePagination.jsx
"use client";
            ...
            <div className="flex items-center gap-2 text-sm text-muted">
                ...
                <div className="relative">
                    <select
                        ...
                        className="appearance-none rounded-full border border-line bg-card py-1.5 pl-3 pr-8 text-sm font-bold text-ink-2 focus:border-brand/50 focus:outline-none"
                    >
                        {ROWS_OPTIONS.map((n) => (

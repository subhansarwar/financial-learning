// app/components/adminPanelComp/manageCaseStudies/caseStudiesComp/DeleteConfirmModal.jsx
"use client";

import { Trash2, X, AlertTriangle } from "lucide-react";

export default function DeleteConfirmModal({ isOpen, onClose, onConfirm, caseTitle }) {
            ...
            >
                <div className="flex items-center justify-between mb-4">
                    <div className="flex items-center gap-3">
                        ...
                        <h3 className="text-xl font-bold text-ink">Delete Case Study</h3>
                    </div>
                    <button
                        onClick={onClose}
                ...
                <div className="flex items-start gap-3 rounded-lg bg-rose-50 p-3 mb-4">
                    ...
                    <div>
                        ...
                        <p className="text-sm text-rose-600">
                            You are about to delete <span className="font-bold">"{caseTitle}"</span> permanently.
                        </p>
                    </div>
                </div>

                <p className="text-sm text-muted mb-6">
                    This will remove the case study from the platform. Are you sure you want to continue?
                </p>

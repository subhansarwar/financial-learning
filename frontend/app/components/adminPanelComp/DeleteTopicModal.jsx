// app/admin/components/DeleteTopicModal.jsx
"use client";

import { Trash2, X, AlertCircle } from "lucide-react";

export default function DeleteTopicModal({ isOpen, onClose, onConfirm, topicName }) {
            ...
            >
                <div className="flex items-center justify-between mb-4">
                    <div className="flex items-center gap-3">
                        ...
                        <h3 className="text-xl font-bold text-ink">Delete Topic</h3>
                    </div>
                    <button
                        onClick={onClose}
                ...
                <div className="flex items-start gap-3 rounded-lg bg-rose-50 p-3 mb-4">
                    <AlertCircle className="mt-0.5 h-5 w-5 flex-shrink-0 text-rose-600" strokeWidth={2} />
                    <div>
                        <p className="font-bold text-rose-700">Warning: This action cannot be undone!</p>
                        <p className="text-sm text-rose-600">
                            You are about to delete <span className="font-bold">"{topicName}"</span> permanently.
                        </p>
                    </div>
                </div>

                <p className="text-sm text-muted mb-6">
                    This will remove the topic from the platform. Courses assigned to this topic will need to be reassigned.
                </p>

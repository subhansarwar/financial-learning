// app/components/userDashboardComp/userCoursesComp/StepOneInfo.jsx
"use client";
            ...
            <div>
                <Field label="Course Cover">
                    ...
                    <div
                        ...
                        className="flex min-h-[220px] cursor-pointer flex-col items-center justify-center rounded-xl2 border-2 border-dashed border-[#365B50]/40 bg-[#365B50]/10 p-6 text-center transition-colors hover:bg-[#365B50]/20"
                    >
                        <input
                            ref={fileInputRef}
                            type="file"
                        ...
                        <p className="text-sm font-bold text-[#365B50]">

...
async def list_published_publications(
    ...
    publications, _ = await publication_crud.list_published_publications(
...
@router.get("/read/{publication_number}", response_model=PublicationRead)
async def get_publications_by_number(publication_number: str, db: SessionDep) -> PublicationRead:
